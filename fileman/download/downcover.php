...
<div class="topnav" id="myTopnav">
	<a href="#home" class="active">Cover Download</a>
</div>
<?php
$id = $_POST['fsuid2']; //this is a session variable
//echo $id;
$dir = "../stdfiles/" . $id . "/cover/";
//echo "$dir <br>";
...
echo '<h3>Here are the cover letters:</h3>
                <h4><form action="downcov2.php" method="post">';
    while (($file = readdir($dh)) !== false){
        if($file != '.' && $file != '..'){
...
?>
<br>
<!--<form action="downcover2.php" method="post">
